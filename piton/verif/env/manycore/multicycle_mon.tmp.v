...
`ifndef RTL_SPU
          #1 force  `SPARC_CORE2.sparc0.lsu.lsu.dtlb.tlb_wr_tte_tag[54:13] = { 42 {1'bx} } ;
`else
...
`endif          
      ...
      begin
          ...
          begin
             ...
             begin
`ifndef RTL_SPU
                 #1 release `SPARC_CORE2.sparc0.lsu.lsu.dtlb.tlb_wr_tte_tag[54:13];
`else
...
`ifndef RTL_SPU
          #1 force  `SPARC_CORE2.sparc0.lsu.lsu.dtlb.tlb_wr_tte_data[42:0] = { 43 {1'bx} } ;
`else
...
`endif          
      ...
      begin
          ...
          begin
             ...
             begin
`ifndef RTL_SPU
                 #1 release `SPARC_CORE2.sparc0.lsu.lsu.dtlb.tlb_wr_tte_data[42:0];
`else
...
`ifndef RTL_SPU
          #1 force  `SPARC_CORE3.sparc0.lsu.lsu.dtlb.tlb_wr_tte_tag[54:13] = { 42 {1'bx} } ;
`else
...
`endif          
      ...
      begin
          ...
          begin
             ...
             begin
`ifndef RTL_SPU
                 #1 release `SPARC_CORE3.sparc0.lsu.lsu.dtlb.tlb_wr_tte_tag[54:13];
`else
...
`ifndef RTL_SPU
          #1 force  `SPARC_CORE3.sparc0.lsu.lsu.dtlb.tlb_wr_tte_data[42:0] = { 43 {1'bx} } ;
`else
...
`endif          
      ...
      begin
          ...
          begin
             ...
             begin
`ifndef RTL_SPU
                 #1 release `SPARC_CORE3.sparc0.lsu.lsu.dtlb.tlb_wr_tte_data[42:0];
`else
