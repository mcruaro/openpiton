...
fexpr:			// For use as first part of statement (disambiguates <=)
		 		'+' fexpr	%prec prUNARYARITH	{ $$ = $2; } 	|	'-' fexpr	%prec prUNARYARITH	{ $$ = new AstNegate	($1,$2); } 	|	'!' fexpr	%prec prNEGATION	{ $$ = new AstLogNot	($1,$2); } 	|	'&' fexpr	%prec prREDUCTION	{ $$ = new AstRedAnd	($1,$2); } 	|	'~' fexpr	%prec prNEGATION	{ $$ = new AstNot	($1,$2); } 	|	'|' fexpr	%prec prREDUCTION	{ $$ = new AstRedOr	($1,$2); } 	|	'^' fexpr	%prec prREDUCTION	{ $$ = new AstRedXor	($1,$2); } 	|	yP_NAND fexpr	%prec prREDUCTION	{ $$ = new AstLogNot($1,new AstRedAnd($1,$2)); } 	|	yP_NOR  fexpr	%prec prREDUCTION	{ $$ = new AstLogNot($1,new AstRedOr ($1,$2)); } 	|	yP_XNOR fexpr	%prec prREDUCTION	{ $$ = new AstRedXnor	($1,$2); } 	|	fexpr '+' fexpr			{ $$ = new AstAdd	($2,$1,$3); } 	|	fexpr '-' fexpr			{ $$ = new AstSub	($2,$1,$3); } 	|	fexpr '*' fexpr			{ $$ = new AstMul	($2,$1,$3); } 	|	fexpr '/' fexpr			{ $$ = new AstDiv	($2,$1,$3); } 	|	fexpr '%' fexpr			{ $$ = new AstModDiv	($2,$1,$3); } 	|	fexpr yP_EQUAL fexpr		{ $$ = new AstEq	($2,$1,$3); } 	|	fexpr yP_NOTEQUAL fexpr		{ $$ = new AstNeq	($2,$1,$3); } 	|	fexpr yP_CASEEQUAL fexpr		{ $$ = new AstEqCase	($2,$1,$3); } 	|	fexpr yP_CASENOTEQUAL fexpr		{ $$ = new AstNeqCase	($2,$1,$3); } 	|	fexpr yP_WILDEQUAL fexpr		{ $$ = new AstEqWild	($2,$1,$3); } 	|	fexpr yP_WILDNOTEQUAL fexpr		{ $$ = new AstNeqWild	($2,$1,$3); } 	|	fexpr yP_ANDAND fexpr		{ $$ = new AstLogAnd	($2,$1,$3); } 	|	fexpr yP_OROR fexpr			{ $$ = new AstLogOr	($2,$1,$3); } 	|	fexpr yP_POW fexpr			{ $$ = new AstPow	($2,$1,$3); } 	|	fexpr '<' fexpr			{ $$ = new AstLt	($2,$1,$3); } 	|	fexpr '>' fexpr			{ $$ = new AstGt	($2,$1,$3); } 	|	fexpr yP_GTE fexpr			{ $$ = new AstGte	($2,$1,$3); } 	|	fexpr '&' fexpr			{ $$ = new AstAnd	($2,$1,$3); } 	|	fexpr '|' fexpr			{ $$ = new AstOr	($2,$1,$3); } 	|	fexpr '^' fexpr			{ $$ = new AstXor	($2,$1,$3); } 	|	fexpr yP_XNOR fexpr			{ $$ = new AstXnor	($2,$1,$3); } 	|	fexpr yP_NOR fexpr			{ $$ = new AstNot($2,new AstOr	($2,$1,$3)); } 	|	fexpr yP_NAND fexpr			{ $$ = new AstNot($2,new AstAnd	($2,$1,$3)); } 	|	fexpr yP_SLEFT fexpr		{ $$ = new AstShiftL	($2,$1,$3); } 	|	fexpr yP_SRIGHT fexpr		{ $$ = new AstShiftR	($2,$1,$3); } 	|	fexpr yP_SSRIGHT fexpr		{ $$ = new AstShiftRS	($2,$1,$3); } 	|	fexpr yP_LTE__IGNORE fexpr	{ $$ = new AstLte	($2,$1,$3); } 	|	fexpr '?' fexpr ':' fexpr		{ $$ = new AstCond($2,$1,$3,$5); } 	|	fexpr yINSIDE '{' open_range_list '}'	{ $$ = new AstInside($2,$1,$4); } 	|	fexpr yP_MINUSGT fexpr		{ $$ = new AstLogIf	($2,$1,$3); } 	|	fexpr yP_LOGIFF fexpr		{ $$ = new AstLogIff	($2,$1,$3); } 	|	yaINTNUM				{ $$ = new AstConst($<fl>1,*$1); } 	|	yaFLOATNUM				{ $$ = new AstConst($<fl>1,AstConst::RealDouble(),$1); } 	|	strAsInt			{ $$ = $1; } 	|	'{' constExpr '{' cateList '}' '}'	{ $$ = new AstReplicate($1,$4,$2); } 	|	function_subroutine_callNoMethod	{ $$ = $1; } 	|	fexpr '.' function_subroutine_callNoMethod	{ $$ = new AstDot($2,$1,$3); } 	|	fexpr '.' array_methodNoRoot		{ $$ = new AstDot($2,$1,$3); } 	|	'(' expr ')'		{ $$ = $2; } 	|	'_' '(' expr ')'			{ $$ = $3; } 	|	casting_type yP_TICK '(' expr ')'	{ $$ = new AstCast($2,$4,$1); } 	|	ySIGNED	     yP_TICK '(' expr ')'	{ $$ = new AstSigned($1,$4); } 	|	yUNSIGNED    yP_TICK '(' expr ')'	{ $$ = new AstUnsigned($1,$4); } 	|	fexpr      yP_TICK '(' expr ')'	{ $$ = new AstCastParse($2,$4,$1); } 	|	fexprOkLvalue				{ $$ = $1; } 	// {copied}
	;

exprNoStr:		// expression with string removed
		 		'+' expr	%prec prUNARYARITH	{ $$ = $2; } 	|	'-' expr	%prec prUNARYARITH	{ $$ = new AstNegate	($1,$2); } 	|	'!' expr	%prec prNEGATION	{ $$ = new AstLogNot	($1,$2); } 	|	'&' expr	%prec prREDUCTION	{ $$ = new AstRedAnd	($1,$2); } 	|	'~' expr	%prec prNEGATION	{ $$ = new AstNot	($1,$2); } 	|	'|' expr	%prec prREDUCTION	{ $$ = new AstRedOr	($1,$2); } 	|	'^' expr	%prec prREDUCTION	{ $$ = new AstRedXor	($1,$2); } 	|	yP_NAND expr	%prec prREDUCTION	{ $$ = new AstLogNot($1,new AstRedAnd($1,$2)); } 	|	yP_NOR  expr	%prec prREDUCTION	{ $$ = new AstLogNot($1,new AstRedOr ($1,$2)); } 	|	yP_XNOR expr	%prec prREDUCTION	{ $$ = new AstRedXnor	($1,$2); } 	|	expr '+' expr			{ $$ = new AstAdd	($2,$1,$3); } 	|	expr '-' expr			{ $$ = new AstSub	($2,$1,$3); } 	|	expr '*' expr			{ $$ = new AstMul	($2,$1,$3); } 	|	expr '/' expr			{ $$ = new AstDiv	($2,$1,$3); } 	|	expr '%' expr			{ $$ = new AstModDiv	($2,$1,$3); } 	|	expr yP_EQUAL expr		{ $$ = new AstEq	($2,$1,$3); } 	|	expr yP_NOTEQUAL expr		{ $$ = new AstNeq	($2,$1,$3); } 	|	expr yP_CASEEQUAL expr		{ $$ = new AstEqCase	($2,$1,$3); } 	|	expr yP_CASENOTEQUAL expr		{ $$ = new AstNeqCase	($2,$1,$3); } 	|	expr yP_WILDEQUAL expr		{ $$ = new AstEqWild	($2,$1,$3); } 	|	expr yP_WILDNOTEQUAL expr		{ $$ = new AstNeqWild	($2,$1,$3); } 	|	expr yP_ANDAND expr		{ $$ = new AstLogAnd	($2,$1,$3); } 	|	expr yP_OROR expr			{ $$ = new AstLogOr	($2,$1,$3); } 	|	expr yP_POW expr			{ $$ = new AstPow	($2,$1,$3); } 	|	expr '<' expr			{ $$ = new AstLt	($2,$1,$3); } 	|	expr '>' expr			{ $$ = new AstGt	($2,$1,$3); } 	|	expr yP_GTE expr			{ $$ = new AstGte	($2,$1,$3); } 	|	expr '&' expr			{ $$ = new AstAnd	($2,$1,$3); } 	|	expr '|' expr			{ $$ = new AstOr	($2,$1,$3); } 	|	expr '^' expr			{ $$ = new AstXor	($2,$1,$3); } 	|	expr yP_XNOR expr			{ $$ = new AstXnor	($2,$1,$3); } 	|	expr yP_NOR expr			{ $$ = new AstNot($2,new AstOr	($2,$1,$3)); } 	|	expr yP_NAND expr			{ $$ = new AstNot($2,new AstAnd	($2,$1,$3)); } 	|	expr yP_SLEFT expr		{ $$ = new AstShiftL	($2,$1,$3); } 	|	expr yP_SRIGHT expr		{ $$ = new AstShiftR	($2,$1,$3); } 	|	expr yP_SSRIGHT expr		{ $$ = new AstShiftRS	($2,$1,$3); } 	|	expr yP_LTE expr	{ $$ = new AstLte	($2,$1,$3); } 	|	expr '?' expr ':' expr		{ $$ = new AstCond($2,$1,$3,$5); } 	|	expr yINSIDE '{' open_range_list '}'	{ $$ = new AstInside($2,$1,$4); } 	|	expr yP_MINUSGT expr		{ $$ = new AstLogIf	($2,$1,$3); } 	|	expr yP_LOGIFF expr		{ $$ = new AstLogIff	($2,$1,$3); } 	|	yaINTNUM				{ $$ = new AstConst($<fl>1,*$1); } 	|	yaFLOATNUM				{ $$ = new AstConst($<fl>1,AstConst::RealDouble(),$1); } 	|	strAsIntIgnore			{ $$ = $1; } 	|	'{' constExpr '{' cateList '}' '}'	{ $$ = new AstReplicate($1,$4,$2); } 	|	function_subroutine_callNoMethod	{ $$ = $1; } 	|	expr '.' function_subroutine_callNoMethod	{ $$ = new AstDot($2,$1,$3); } 	|	expr '.' array_methodNoRoot		{ $$ = new AstDot($2,$1,$3); } 	|	'(' expr ')'		{ $$ = $2; } 	|	'_' '(' expr ')'			{ $$ = $3; } 	|	casting_type yP_TICK '(' expr ')'	{ $$ = new AstCast($2,$4,$1); } 	|	ySIGNED	     yP_TICK '(' expr ')'	{ $$ = new AstSigned($1,$4); } 	|	yUNSIGNED    yP_TICK '(' expr ')'	{ $$ = new AstUnsigned($1,$4); } 	|	expr      yP_TICK '(' expr ')'	{ $$ = new AstCastParse($2,$4,$1); } 	|	exprOkLvalue				{ $$ = $1; } 	// {copied}
	;
...
fexprScope:		// exprScope, For use as first part of statement (disambiguates <=)
		 		idArrayed				{ $$ = $1; } 	|	package_scopeIdFollows idArrayed	{ $$ = AstDot::newIfPkg($2->fileline(), $1, $2); } 	|	fexpr '.' idArrayed			{ $$ = new AstDot($<fl>2,$1,$3); } 	// {copied}
	;
...
junkToSemi:
			 '!' { }	| '#' { }	| '%' { }	| '&' { }	| '(' { }	| ')' { }	| '*' { }	| '+' { }	| ',' { }	| '-' { }	| '.' { }	| '/' { }	| ':' { }	| '<' { }	| '=' { }	| '>' { }	| '?' { }	| '@' { }	| '[' { }	| ']' { }	| '^' { }	| '{' { }	| '|' { }	| '}' { }	| '~' { }	| yALWAYS { }	| yALWAYS_COMB { }	| yALWAYS_FF { }	| yALWAYS_LATCH { }	| yAND { }	| yASSERT { }	| yASSIGN { }	| yASSUME { }	| yAUTOMATIC { }	| yBEGIN { }	| yBIND { }	| yBIT { }	| yBREAK { }	| yBUF { }	| yBUFIF0 { }	| yBUFIF1 { }	| yBYTE { }	| yCASE { }	| yCASEX { }	| yCASEZ { }	| yCHANDLE { }	| yCLOCKING { }	| yCMOS { }	| yCONST__ETC { }	| yCONST__LEX { }	| yCONST__REF { }	| yCONTEXT { }	| yCONTINUE { }	| yCOVER { }	| yDEASSIGN { }	| yDEFAULT { }	| yDEFPARAM { }	| yDISABLE { }	| yDO { }	| yD_ACOS { }	| yD_ACOSH { }	| yD_ASIN { }	| yD_ASINH { }	| yD_ATAN { }	| yD_ATAN2 { }	| yD_ATANH { }	| yD_BITS { }	| yD_BITSTOREAL { }	| yD_C { }	| yD_CEIL { }	| yD_CLOG2 { }	| yD_COS { }	| yD_COSH { }	| yD_COUNTONES { }	| yD_DIMENSIONS { }	| yD_DISPLAY { }	| yD_ERROR { }	| yD_EXP { }	| yD_FATAL { }	| yD_FCLOSE { }	| yD_FDISPLAY { }	| yD_FEOF { }	| yD_FFLUSH { }	| yD_FGETC { }	| yD_FGETS { }	| yD_FINISH { }	| yD_FLOOR { }	| yD_FOPEN { }	| yD_FREAD { }	| yD_FSCANF { }	| yD_FWRITE { }	| yD_HIGH { }	| yD_HYPOT { }	| yD_INCREMENT { }	| yD_INFO { }	| yD_ISUNKNOWN { }	| yD_ITOR { }	| yD_LEFT { }	| yD_LN { }	| yD_LOG10 { }	| yD_LOW { }	| yD_ONEHOT { }	| yD_ONEHOT0 { }	| yD_PAST { }	| yD_POW { }	| yD_RANDOM { }	| yD_READMEMB { }	| yD_READMEMH { }	| yD_REALTIME { }	| yD_REALTOBITS { }	| yD_RIGHT { }	| yD_RTOI { }	| yD_SFORMAT { }	| yD_SFORMATF { }	| yD_SIGNED { }	| yD_SIN { }	| yD_SINH { }	| yD_SIZE { }	| yD_SQRT { }	| yD_SSCANF { }	| yD_STIME { }	| yD_STOP { }	| yD_SWRITE { }	| yD_SYSTEM { }	| yD_TAN { }	| yD_TANH { }	| yD_TESTPLUSARGS { }	| yD_TIME { }	| yD_UNIT { }	| yD_UNPACKED_DIMENSIONS { }	| yD_UNSIGNED { }	| yD_VALUEPLUSARGS { }	| yD_WARNING { }	| yD_WRITE { }	| yD_WRITEMEMH { }	| yEDGE { }	| yELSE { }	| yEND { }	| yENDCASE { }	| yENDCLOCKING { }	| yENDFUNCTION { }	| yENDGENERATE { }	| yENDINTERFACE { }	| yENDPACKAGE { }	| yENDPRIMITIVE { }	| yENDPROGRAM { }	| yENDPROPERTY { }	| yENDTABLE { }	| yENDTASK { }	| yENUM { }	| yEXPORT { }	| yEXTERN { }	| yFINAL { }	| yFOR { }	| yFOREACH { }	| yFOREVER { }	| yFORKJOIN { }	| yFUNCTION { }	| yGENERATE { }	| yGENVAR { }	| yGLOBAL__CLOCKING { }	| yGLOBAL__LEX { }	| yIF { }	| yIFF { }	| yIMPORT { }	| yINITIAL { }	| yINOUT { }	| yINPUT { }	| yINSIDE { }	| yINT { }	| yINTEGER { }	| yINTERFACE { }	| yLOCALPARAM { }	| yLOGIC { }	| yLONGINT { }	| yMODPORT { }	| yMODULE { }	| yNAND { }	| yNEGEDGE { }	| yNMOS { }	| yNOR { }	| yNOT { }	| yNOTIF0 { }	| yNOTIF1 { }	| yOR { }	| yOUTPUT { }	| yPACKAGE { }	| yPACKED { }	| yPARAMETER { }	| yPMOS { }	| yPOSEDGE { }	| yPRIMITIVE { }	| yPRIORITY { }	| yPROGRAM { }	| yPROPERTY { }	| yPULLDOWN { }	| yPULLUP { }	| yPURE { }	| yP_ANDAND { }	| yP_ANDANDAND { }	| yP_ANDEQ { }	| yP_ASTGT { }	| yP_ATAT { }	| yP_BRAEQ { }	| yP_BRAMINUSGT { }	| yP_BRASTAR { }	| yP_CASEEQUAL { }	| yP_CASENOTEQUAL { }	| yP_COLONCOLON { }	| yP_COLONDIV { }	| yP_COLONEQ { }	| yP_DIVEQ { }	| yP_DOTSTAR { }	| yP_EQGT { }	| yP_EQUAL { }	| yP_GTE { }	| yP_LOGIFF { }	| yP_LTE { }	| yP_LTE__IGNORE { }	| yP_MINUSCOLON { }	| yP_MINUSEQ { }	| yP_MINUSGT { }	| yP_MINUSGTGT { }	| yP_MINUSMINUS { }	| yP_MODEQ { }	| yP_NAND { }	| yP_NOR { }	| yP_NOTEQUAL { }	| yP_OREQ { }	| yP_OREQGT { }	| yP_ORMINUSGT { }	| yP_OROR { }	| yP_PLUSCOLON { }	| yP_PLUSEQ { }	| yP_PLUSPLUS { }	| yP_POUNDPOUND { }	| yP_POW { }	| yP_SLEFT { }	| yP_SLEFTEQ { }	| yP_SRIGHT { }	| yP_SRIGHTEQ { }	| yP_SSRIGHT { }	| yP_SSRIGHTEQ { }	| yP_TICK { }	| yP_TICKBRA { }	| yP_TIMESEQ { }	| yP_WILDEQUAL { }	| yP_WILDNOTEQUAL { }	| yP_XNOR { }	| yP_XOREQ { }	| yRAND { }	| yRANDC { }	| yRCMOS { }	| yREAL { }	| yREALTIME { }	| yREF { }	| yREG { }	| yREPEAT { }	| yRESTRICT { }	| yRETURN { }	| yRNMOS { }	| yRPMOS { }	| yRTRAN { }	| yRTRANIF0 { }	| yRTRANIF1 { }	| ySCALARED { }	| ySHORTINT { }	| ySHORTREAL { }	| ySIGNED { }	| ySPECIFY { }	| ySPECPARAM { }	| ySTATIC { }	| ySTRING { }	| ySTRUCT { }	| ySUPPLY0 { }	| ySUPPLY1 { }	| yTABLE { }	| yTASK { }	| yTIME { }	| yTIMEPRECISION { }	| yTIMEUNIT { }	| yTRAN { }	| yTRANIF0 { }	| yTRANIF1 { }	| yTRI { }	| yTRI0 { }	| yTRI1 { }	| yTRUE { }	| yTYPE { }	| yTYPEDEF { }	| yUNION { }	| yUNIQUE { }	| yUNIQUE0 { }	| yUNSIGNED { }	| yVAR { }	| yVECTORED { }	| yVLT_COVERAGE_OFF { }	| yVLT_COVERAGE_ON { }	| yVLT_D_FILE { }	| yVLT_D_LINES { }	| yVLT_D_MSG { }	| yVLT_LINT_OFF { }	| yVLT_LINT_ON { }	| yVLT_TRACING_OFF { }	| yVLT_TRACING_ON { }	| yVL_CLOCK { }	| yVL_CLOCKER { }	| yVL_CLOCK_ENABLE { }	| yVL_COVERAGE_BLOCK_OFF { }	| yVL_FULL_CASE { }	| yVL_INLINE_MODULE { }	| yVL_ISOLATE_ASSIGNMENTS { }	| yVL_NO_CLOCKER { }	| yVL_NO_INLINE_MODULE { }	| yVL_NO_INLINE_TASK { }	| yVL_PARALLEL_CASE { }	| yVL_PUBLIC { }	| yVL_PUBLIC_FLAT { }	| yVL_PUBLIC_FLAT_RD { }	| yVL_PUBLIC_FLAT_RW { }	| yVL_PUBLIC_MODULE { }	| yVL_SC_BV { }	| yVL_SFORMAT { }	| yVOID { }	| yWHILE { }	| yWIRE { }	| yWREAL { }	| yXNOR { }	| yXOR { }	| yaD_DPI { }	| yaD_IGNORE { }	| yaFLOATNUM { }	| yaID__ETC { }	| yaID__LEX { }	| yaID__aPACKAGE { }	| yaID__aTYPE { }	| yaINTNUM { }	| yaSCCTOR { }	| yaSCDTOR { }	| yaSCHDR { }	| yaSCIMP { }	| yaSCIMPH { }	| yaSCINT { }	| yaSTRING { }	| yaSTRING__IGNORE { }	| yaTABLELINE { }	| yaTIMENUM { }	| yaTIMINGSPEC { }
	|	error {}
	;
