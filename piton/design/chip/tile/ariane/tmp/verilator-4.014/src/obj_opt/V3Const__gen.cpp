...
#line 2155 "V3Const__gen.cpp"
	...
	if (m_doNConst && operandsSame(nodep->lhsp(),nodep->rhsp())) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstChangeXor operandsSame($lhsp,,$rhsp) , replaceZero(nodep) )\n");
	    replaceZero(nodep);
	    return true;
	}
	return false;
	...
	if (m_doV && VN_IS(nodep->lhsp(),Sel) && VN_IS(nodep->rhsp(),Sel) && ifAdjacentSel(VN_CAST(nodep->lhsp(),Sel),VN_CAST(nodep->rhsp(),Sel))) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstConcat $lhsp.castSel, $rhsp.castSel, ifAdjacentSel(VN_CAST($lhsp,,Sel),,VN_CAST($rhsp,,Sel)) , replaceConcatSel(nodep) )\n");
	...
	if (m_doV && ifConcatMergeableBiop(nodep->lhsp()) && concatMergeable(nodep->lhsp(),nodep->rhsp())) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstConcat ifConcatMergeableBiop($lhsp), concatMergeable($lhsp,,$rhsp) , replaceConcatMerge(nodep) )\n");
	...
	if (m_doNConst && VN_IS(nodep->condp(),Not)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstCond $condp.castNot, $expr1p, $expr2p , AstCond $condp->op1p(), $expr2p, $expr1p )\n");
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (VN_IS(nodep->lhsp(),Const)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPC( AstCvtPackString $lhsp.castConst , replaceConstString(nodep, VN_CAST(nodep->lhsp(), Const)->num().toString()) )\n");
	    replaceConstString(nodep, VN_CAST(nodep->lhsp(), Const)->num().toString());
	    return true;
	}
	return false;
    }
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),Extend)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstExtend $lhsp.castExtend , replaceExtend(nodep, VN_CAST(nodep->lhsp(), Extend)->lhsp()) )\n");
	    replaceExtend(nodep, VN_CAST(nodep->lhsp(), Extend)->lhsp());
	    return true;
	}
	return false;
    }
	...
	if (m_doV && VN_IS(nodep->lhsp(),ExtendS)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstExtendS $lhsp.castExtendS , replaceExtend(nodep, VN_CAST(nodep->lhsp(), ExtendS)->lhsp()) )\n");
	    replaceExtend(nodep, VN_CAST(nodep->lhsp(), ExtendS)->lhsp());
	    return true;
	}
	return false;
    }
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && nodep->lhsp()->isNeqZero()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogAnd $lhsp.isNeqZero, $rhsp , replaceWRhs(nodep) )\n");
	    replaceWRhs(nodep);
	    return true;
	}
	return false;
	...
	if (m_doNConst && nodep->rhsp()->isNeqZero()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogAnd $lhsp, $rhsp.isNeqZero , replaceWLhs(nodep) )\n");
	    replaceWLhs(nodep);
	    return true;
	}
	return false;
	...
	if (m_doNConst && operandsSame(nodep->lhsp(),nodep->rhsp()) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogAnd operandsSame($lhsp,,$rhsp), $lhsp.width1 , replaceWLhs(nodep) )\n");
	    replaceWLhs(nodep);
	    return true;
	}
	return false;
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstLogIff $lhsp, $rhsp , AstLogNot AstXor $lhsp,$rhsp )\n");
	    AstNode* arg1p = nodep->lhsp()->unlinkFrBack();
AstNode* arg2p = nodep->rhsp()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),LogNot)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castLogNot , replaceWChild(nodep, $lhsp->op1p()) )\n");
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),EqCase)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castEqCase , AstNeqCase $lhsp->op1p(),$lhsp->op2p() )\n");
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),NeqCase)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castNeqCase , AstEqCase $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),EqWild)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castEqWild , AstNeqWild $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),NeqWild)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castNeqWild , AstEqWild $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),Eq)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castEq , AstNeq $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),Neq)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castNeq , AstEq $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),Lt)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castLt , AstGte $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),LtS)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castLtS , AstGteS $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),Lte)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castLte , AstGt $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),LteS)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castLteS , AstGtS $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),Gt)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castGt , AstLte $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstLte(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),GtS)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castGtS , AstLteS $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstLteS(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),Gte)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castGte , AstLt $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstLt(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),GteS)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogNot $lhsp.castGteS , AstLtS $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstLtS(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && nodep->lhsp()->isZero()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogOr $lhsp.isZero, $rhsp , replaceWRhs(nodep) )\n");
	    replaceWRhs(nodep);
	    return true;
	}
	return false;
	...
	if (m_doNConst && nodep->rhsp()->isZero()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogOr $lhsp, $rhsp.isZero , replaceWLhs(nodep) )\n");
	    replaceWLhs(nodep);
	    return true;
	}
	return false;
	...
	if (m_doNConst && nodep->rhsp()->isNeqZero() && isTPure(nodep->lhsp())) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogOr $lhsp, $rhsp.isNeqZero, isTPure($lhsp) , replaceNum(nodep,1) )\n");
	    replaceNum(nodep,1);
	    return true;
	}
	return false;
	...
	if (m_doNConst && operandsSame(nodep->lhsp(),nodep->rhsp()) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstLogOr operandsSame($lhsp,,$rhsp), $lhsp.width1 , replaceWLhs(nodep) )\n");
	    replaceWLhs(nodep);
	    return true;
	}
	return false;
	...
	if (m_doV && nodep->lhsp()->width1() && nodep->rhsp()->width1() && isTPure(nodep->lhsp()) && isTPure(nodep->rhsp())) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstLogOr $lhsp.width1, $rhsp.width1, isTPure($lhsp), isTPure($rhsp) , AstOr $lhsp,$rhsp )\n");
	    AstNode* arg1p = nodep->lhsp()->unlinkFrBack();
AstNode* arg2p = nodep->rhsp()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && operandIsPowTwo(nodep->lhsp())) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstMul operandIsPowTwo($lhsp), $rhsp , replaceMulShift(nodep) )\n");
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (VN_IS(nodep->lhsp(),Const) && VN_IS(nodep->rhsp(),Const)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPC( AstNodeBiop $lhsp.castConst, $rhsp.castConst , replaceConst(nodep) )\n");
	    replaceConst(nodep);
	    return true;
	}
	return false;
	...
	if (m_doNConst && nodep->condp()->isZero()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstNodeCond $condp.isZero, $expr1p, $expr2p , replaceWChild(nodep,$expr2p) )\n");
	...
	if (m_doNConst && nodep->condp()->isNeqZero()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstNodeCond $condp.isNeqZero, $expr1p, $expr2p , replaceWChild(nodep,$expr1p) )\n");
	...
	if (nodep->condp()->isZero() && VN_IS(nodep->expr1p(),Const) && VN_IS(nodep->expr2p(),Const)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPC( AstNodeCond $condp.isZero, $expr1p.castConst, $expr2p.castConst , replaceWChild(nodep,$expr2p) )\n");
	    replaceWChild(nodep,nodep->expr2p());
	    return true;
	}
	return false;
	...
	if (nodep->condp()->isNeqZero() && VN_IS(nodep->expr1p(),Const) && VN_IS(nodep->expr2p(),Const)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPC( AstNodeCond $condp.isNeqZero, $expr1p.castConst, $expr2p.castConst , replaceWChild(nodep,$expr1p) )\n");
	    replaceWChild(nodep,nodep->expr1p());
	    return true;
	}
	return false;
	...
	if (m_doNConst && operandsSame(nodep->expr1p(),nodep->expr2p())) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstNodeCond $condp, operandsSame($expr1p,,$expr2p) , replaceWChild(nodep,$expr1p) )\n");
	    replaceWChild(nodep,nodep->expr1p());
	    return true;
	}
	return false;
	...
	if (m_doNConst && nodep->condp()->width1() && nodep->expr1p()->width1() && nodep->expr1p()->isAllOnes()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstNodeCond $condp.width1, $expr1p.width1, $expr1p.isAllOnes, $expr2p , AstLogOr $condp, $expr2p )\n");
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && nodep->condp()->width1() && nodep->expr1p()->width1() && nodep->expr2p()->isZero()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstNodeCond $condp.width1, $expr1p.width1, $expr1p, $expr2p.isZero , AstLogAnd $condp, $expr1p )\n");
	    AstNode* arg1p = nodep->condp()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && nodep->condp()->width1() && nodep->expr1p()->width1() && nodep->expr2p()->isAllOnes()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstNodeCond $condp.width1, $expr1p.width1, $expr1p, $expr2p.isAllOnes , AstLogOr AstNot $condp , $expr1p )\n");
	    AstNode* arg1p = nodep->condp()->unlinkFrBack();
AstNode* arg2p = nodep->expr1p()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && nodep->condp()->width1() && nodep->expr1p()->width1() && nodep->expr1p()->isZero()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstNodeCond $condp.width1, $expr1p.width1, $expr1p.isZero, $expr2p , AstLogAnd AstNot $condp , $expr2p )\n");
	    AstNode* arg1p = nodep->condp()->unlinkFrBack();
AstNode* arg2p = nodep->expr2p()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (VN_IS(nodep->lhsp(),Const) && !nodep->isOpaque()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPC( AstNodeUniop $lhsp.castConst, !nodep->isOpaque() , replaceConst(nodep) )\n");
	    replaceConst(nodep);
	    return true;
	}
	return false;
	...
	// TREEOP ("AstNot   {$lhsp.castNot,  $lhsp->width()==VN_CAST($lhsp,,Not)->lhsp()->width()}", "replaceWChild(nodep, $lhsp->op1p())")
	if (m_doNConst && VN_IS(nodep->lhsp(),Not) && nodep->lhsp()->width()==VN_CAST(nodep->lhsp(),Not)->lhsp()->width()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstNot $lhsp.castNot, $lhsp->width()==VN_CAST($lhsp,,Not)->lhsp()->width() , replaceWChild(nodep, $lhsp->op1p()) )\n");
	    replaceWChild(nodep, nodep->lhsp()->op1p());
	    return true;
	}
	return false;
	...
	if (m_doV && VN_IS(nodep->lhsp(),EqCase) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castEqCase, $lhsp.width1 , AstNeqCase $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstNeqCase(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),NeqCase) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castNeqCase, $lhsp.width1 , AstEqCase $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstEqCase(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),EqWild) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castEqWild, $lhsp.width1 , AstNeqWild $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstNeqWild(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),NeqWild) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castNeqWild, $lhsp.width1 , AstEqWild $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstEqWild(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),Eq) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castEq, $lhsp.width1 , AstNeq $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstNeq(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),Neq) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castNeq, $lhsp.width1 , AstEq $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstEq(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),Lt) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castLt, $lhsp.width1 , AstGte $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstGte(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),LtS) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castLtS, $lhsp.width1 , AstGteS $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstGteS(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),Lte) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castLte, $lhsp.width1 , AstGt $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstGt(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),LteS) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castLteS, $lhsp.width1 , AstGtS $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstGtS(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),Gt) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castGt, $lhsp.width1 , AstLte $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstLte(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),GtS) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castGtS, $lhsp.width1 , AstLteS $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstLteS(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),Gte) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castGte, $lhsp.width1 , AstLt $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstLt(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),GteS) && nodep->lhsp()->width1()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstNot $lhsp.castGteS, $lhsp.width1 , AstLtS $lhsp->op1p(),$lhsp->op2p() )\n");
	    AstNode* arg1p = nodep->lhsp()->op1p()->unlinkFrBack();
AstNode* arg2p = nodep->lhsp()->op2p()->unlinkFrBack();
AstNode* newp = new AstLtS(nodep->fileline(), arg1p, arg2p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),Concat)) {
	    ...
	    AstNode* arg1p = VN_CAST(nodep->lhsp(),Concat)->lhsp()->unlinkFrBack();
AstNode* arg2p = VN_CAST(nodep->lhsp(),Concat)->rhsp()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	// TREEOPV("AstRedAnd{$lhsp.castExtend, $lhsp->width() > VN_CAST($lhsp,,Extend)->lhsp()->width()}", "replaceZero(nodep)")
	if (m_doV && VN_IS(nodep->lhsp(),Extend) && nodep->lhsp()->width() > VN_CAST(nodep->lhsp(),Extend)->lhsp()->width()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstRedAnd $lhsp.castExtend, $lhsp->width() > VN_CAST($lhsp,,Extend)->lhsp()->width() , replaceZero(nodep) )\n");
	    replaceZero(nodep);
	    return true;
	}
	return false;
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->lhsp(),Extend)) {
	    ...
	    AstNode* arg1p = VN_CAST(nodep->lhsp(),Extend)->lhsp()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstRedXnor $lhsp , AstNot AstRedXor $lhsp )\n");
	    AstNode* arg1p = nodep->lhsp()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doV && VN_IS(nodep->fromp(),Xnor) && operandSelBiLower(nodep)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstSel $fromp.castXnor,operandSelBiLower(nodep) , DONE )\n");
	...
	if (VN_IS(nodep->fromp(),Const) && VN_IS(nodep->lsbp(),Const) && VN_IS(nodep->widthp(),Const)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPC( AstSel $fromp.castConst, $lsbp.castConst, $widthp.castConst, , replaceConst(nodep) )\n");
	    replaceConst(nodep);
	    return true;
	}
	return false;
	...
	if (m_doV && VN_IS(nodep->fromp(),Xnor) && VN_IS(nodep->lhsp(),Const)) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOPV( AstSel $fromp.castXnor,$lhsp.castConst , replaceSelIntoUniop(nodep) )\n");
	    replaceSelIntoUniop(nodep);
	    return true;
	}
	return false;
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && VN_IS(nodep->lhsp(),Add) && operandSubAdd(nodep)) {
	    ...
	    AstNode* arg1p = VN_CAST(nodep->lhsp(),Add)->lhsp()->unlinkFrBack();
AstNode* arg2p = nodep->rhsp()->unlinkFrBack();
AstNode* arg3p = VN_CAST(nodep->lhsp(),Add)->rhsp()->unlinkFrBack();
...
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	...
	if (m_doNConst && nodep->lhsp()->isZero()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstXnor $lhsp.isZero, $rhsp , AstNot $rhsp )\n");
	    AstNode* arg1p = nodep->rhsp()->unlinkFrBack();
AstNode* newp = new AstNot(nodep->fileline(), arg1p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	    return true;
	...
	if (m_doNConst && nodep->rhsp()->isZero()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstXnor $lhsp, $rhsp.isZero , AstNot $lhsp )\n");
	    AstNode* arg1p = nodep->lhsp()->unlinkFrBack();
AstNode* newp = new AstNot(nodep->fileline(), arg1p);
nodep->replaceWith(newp);nodep->deleteTree(); VL_DANGLING(nodep);
	    return true;
	...
	if (m_doNConst && nodep->lhsp()->isAllOnes()) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstXnor $lhsp.isAllOnes, $rhsp , replaceWRhs(nodep) )\n");
	    replaceWRhs(nodep);
	    return true;
	}
	return false;
	...
	if (m_doNConst && operandsSame(nodep->lhsp(),nodep->rhsp())) {
	    UINFO(7,cvtToHex(nodep)<<" TREEOP ( AstXnor operandsSame($lhsp,,$rhsp) , replaceAllOnes(nodep) )\n");
...
//    TREEOPC("AstNodeBiop {$lhsp.castConst, $rhsp.castConst}",  "replaceConst(nodep)");
#line 5713 "V3Const__gen.cpp"
#line 2152 "../V3Const.cpp"
//    TREEOPC("AstNodeUniop{$lhsp.castConst, !nodep->isOpaque()}",  "replaceConst(nodep)");
#line 5716 "V3Const__gen.cpp"
#line 2153 "../V3Const.cpp"
    // Zero on one side or the other
//    TREEOP ("AstAdd   {$lhsp.isZero, $rhsp}",	"replaceWRhs(nodep)");
#line 5720 "V3Const__gen.cpp"
...
//    TREEOP ("AstMul   {$lhsp, $rhsp.isZero}",	"replaceZeroChkPure(nodep,$lhsp)");
#line 5809 "V3Const__gen.cpp"
#line 2186 "../V3Const.cpp"
//    TREEOP ("AstMulS  {$lhsp, $rhsp.isZero}",	"replaceZeroChkPure(nodep,$lhsp)");
#line 5812 "V3Const__gen.cpp"
#line 2187 "../V3Const.cpp"
//    TREEOP ("AstOr    {$lhsp, $rhsp.isZero}",	"replaceWLhs(nodep)");
#line 5815 "V3Const__gen.cpp"
#line 2188 "../V3Const.cpp"
//    TREEOP ("AstShiftL{$lhsp, $rhsp.isZero}",	"replaceWLhs(nodep)");
#line 5818 "V3Const__gen.cpp"
#line 2189 "../V3Const.cpp"
//    TREEOP ("AstShiftR{$lhsp, $rhsp.isZero}",	"replaceWLhs(nodep)");
#line 5821 "V3Const__gen.cpp"
#line 2190 "../V3Const.cpp"
//    TREEOP ("AstShiftRS{$lhsp, $rhsp.isZero}",	"replaceWLhs(nodep)");
#line 5824 "V3Const__gen.cpp"
...
#line 5927 "V3Const__gen.cpp"
#line 2228 "../V3Const.cpp"
//    TREEOP ("AstNodeCond{!$condp.width1, operandBoolShift(nodep->condp())}", "replaceBoolShift(nodep->condp())");
#line 5930 "V3Const__gen.cpp"
#line 2229 "../V3Const.cpp"
    // Prefer constants on left, since that often needs a shift, it lets constant red remove the shift
//    TREEOP ("AstNodeBiCom{!$lhsp.castConst, $rhsp.castConst}",	"swapSides(nodep)");
#line 5934 "V3Const__gen.cpp"
#line 2231 "../V3Const.cpp"
//    TREEOP ("AstNodeBiComAsv{operandAsvConst(nodep)}",	"replaceAsv(nodep)");
#line 5937 "V3Const__gen.cpp"
#line 2232 "../V3Const.cpp"
//    TREEOP ("AstNodeBiComAsv{operandAsvSame(nodep)}",	"replaceAsv(nodep)");
#line 5940 "V3Const__gen.cpp"
#line 2233 "../V3Const.cpp"
//    TREEOP ("AstNodeBiComAsv{operandAsvLUp(nodep)}",	"replaceAsvLUp(nodep)");
#line 5943 "V3Const__gen.cpp"
#line 2234 "../V3Const.cpp"
//    TREEOP ("AstNodeBiComAsv{operandAsvRUp(nodep)}",	"replaceAsvRUp(nodep)");
#line 5946 "V3Const__gen.cpp"
#line 2235 "../V3Const.cpp"
//    TREEOP ("AstLt   {!$lhsp.castConst,$rhsp.castConst}",	"AstGt  {$rhsp,$lhsp}");
#line 5949 "V3Const__gen.cpp"
#line 2236 "../V3Const.cpp"
//    TREEOP ("AstLtS  {!$lhsp.castConst,$rhsp.castConst}",	"AstGtS {$rhsp,$lhsp}");
#line 5952 "V3Const__gen.cpp"
#line 2237 "../V3Const.cpp"
//    TREEOP ("AstLte  {!$lhsp.castConst,$rhsp.castConst}",	"AstGte {$rhsp,$lhsp}");
#line 5955 "V3Const__gen.cpp"
#line 2238 "../V3Const.cpp"
//    TREEOP ("AstLteS {!$lhsp.castConst,$rhsp.castConst}",	"AstGteS{$rhsp,$lhsp}");
#line 5958 "V3Const__gen.cpp"
#line 2239 "../V3Const.cpp"
//    TREEOP ("AstGt   {!$lhsp.castConst,$rhsp.castConst}",	"AstLt  {$rhsp,$lhsp}");
#line 5961 "V3Const__gen.cpp"
#line 2240 "../V3Const.cpp"
//    TREEOP ("AstGtS  {!$lhsp.castConst,$rhsp.castConst}",	"AstLtS {$rhsp,$lhsp}");
#line 5964 "V3Const__gen.cpp"
#line 2241 "../V3Const.cpp"
//    TREEOP ("AstGte  {!$lhsp.castConst,$rhsp.castConst}",	"AstLte {$rhsp,$lhsp}");
#line 5967 "V3Const__gen.cpp"
#line 2242 "../V3Const.cpp"
//    TREEOP ("AstGteS {!$lhsp.castConst,$rhsp.castConst}",	"AstLteS{$rhsp,$lhsp}");
#line 5970 "V3Const__gen.cpp"
...
//    TREEOPV("AstNot   {$lhsp.castEq, $lhsp.width1}",	"AstNeq {$lhsp->op1p(),$lhsp->op2p()}");
#line 6029 "V3Const__gen.cpp"
#line 2264 "../V3Const.cpp"
//    TREEOP ("AstLogNot{$lhsp.castEq}",			"AstNeq {$lhsp->op1p(),$lhsp->op2p()}");
#line 6032 "V3Const__gen.cpp"
#line 2265 "../V3Const.cpp"
//    TREEOPV("AstNot   {$lhsp.castNeq, $lhsp.width1}",	"AstEq  {$lhsp->op1p(),$lhsp->op2p()}");
#line 6035 "V3Const__gen.cpp"
#line 2266 "../V3Const.cpp"
//    TREEOP ("AstLogNot{$lhsp.castNeq}",			"AstEq  {$lhsp->op1p(),$lhsp->op2p()}");
#line 6038 "V3Const__gen.cpp"
#line 2267 "../V3Const.cpp"
//    TREEOPV("AstNot   {$lhsp.castLt, $lhsp.width1}",	"AstGte {$lhsp->op1p(),$lhsp->op2p()}");
#line 6041 "V3Const__gen.cpp"
#line 2268 "../V3Const.cpp"
//    TREEOP ("AstLogNot{$lhsp.castLt}",			"AstGte {$lhsp->op1p(),$lhsp->op2p()}");
#line 6044 "V3Const__gen.cpp"
#line 2269 "../V3Const.cpp"
//    TREEOPV("AstNot   {$lhsp.castLtS, $lhsp.width1}",	"AstGteS{$lhsp->op1p(),$lhsp->op2p()}");
#line 6047 "V3Const__gen.cpp"
#line 2270 "../V3Const.cpp"
//    TREEOP ("AstLogNot{$lhsp.castLtS}",			"AstGteS{$lhsp->op1p(),$lhsp->op2p()}");
#line 6050 "V3Const__gen.cpp"
#line 2271 "../V3Const.cpp"
//    TREEOPV("AstNot   {$lhsp.castLte, $lhsp.width1}",	"AstGt  {$lhsp->op1p(),$lhsp->op2p()}");
#line 6053 "V3Const__gen.cpp"
#line 2272 "../V3Const.cpp"
//    TREEOP ("AstLogNot{$lhsp.castLte}",			"AstGt  {$lhsp->op1p(),$lhsp->op2p()}");
#line 6056 "V3Const__gen.cpp"
#line 2273 "../V3Const.cpp"
//    TREEOPV("AstNot   {$lhsp.castLteS, $lhsp.width1}",	"AstGtS {$lhsp->op1p(),$lhsp->op2p()}");
#line 6059 "V3Const__gen.cpp"
#line 2274 "../V3Const.cpp"
//    TREEOP ("AstLogNot{$lhsp.castLteS}",		"AstGtS {$lhsp->op1p(),$lhsp->op2p()}");
#line 6062 "V3Const__gen.cpp"
#line 2275 "../V3Const.cpp"
//    TREEOPV("AstNot   {$lhsp.castGt, $lhsp.width1}",	"AstLte {$lhsp->op1p(),$lhsp->op2p()}");
#line 6065 "V3Const__gen.cpp"
#line 2276 "../V3Const.cpp"
//    TREEOP ("AstLogNot{$lhsp.castGt}",			"AstLte {$lhsp->op1p(),$lhsp->op2p()}");
#line 6068 "V3Const__gen.cpp"
#line 2277 "../V3Const.cpp"
//    TREEOPV("AstNot   {$lhsp.castGtS, $lhsp.width1}",	"AstLteS{$lhsp->op1p(),$lhsp->op2p()}");
#line 6071 "V3Const__gen.cpp"
#line 2278 "../V3Const.cpp"
//    TREEOP ("AstLogNot{$lhsp.castGtS}",			"AstLteS{$lhsp->op1p(),$lhsp->op2p()}");
#line 6074 "V3Const__gen.cpp"
#line 2279 "../V3Const.cpp"
//    TREEOPV("AstNot   {$lhsp.castGte, $lhsp.width1}",	"AstLt  {$lhsp->op1p(),$lhsp->op2p()}");
#line 6077 "V3Const__gen.cpp"
#line 2280 "../V3Const.cpp"
//    TREEOP ("AstLogNot{$lhsp.castGte}",			"AstLt  {$lhsp->op1p(),$lhsp->op2p()}");
#line 6080 "V3Const__gen.cpp"
#line 2281 "../V3Const.cpp"
//    TREEOPV("AstNot   {$lhsp.castGteS, $lhsp.width1}",	"AstLtS {$lhsp->op1p(),$lhsp->op2p()}");
#line 6083 "V3Const__gen.cpp"
#line 2282 "../V3Const.cpp"
//    TREEOP ("AstLogNot{$lhsp.castGteS}",		"AstLtS {$lhsp->op1p(),$lhsp->op2p()}");
#line 6086 "V3Const__gen.cpp"
...
//    TREEOPV("AstEq    {$rhsp.castExtend,operandBiExtendConstShrink(nodep)}",	"DONE");
#line 6112 "V3Const__gen.cpp"
#line 2293 "../V3Const.cpp"
//    TREEOPV("AstNeq   {$rhsp.castExtend,operandBiExtendConstShrink(nodep)}",	"DONE");
#line 6115 "V3Const__gen.cpp"
#line 2294 "../V3Const.cpp"
//    TREEOPV("AstGt    {$rhsp.castExtend,operandBiExtendConstShrink(nodep)}",	"DONE");
#line 6118 "V3Const__gen.cpp"
#line 2295 "../V3Const.cpp"
//    TREEOPV("AstGte   {$rhsp.castExtend,operandBiExtendConstShrink(nodep)}",	"DONE");
#line 6121 "V3Const__gen.cpp"
#line 2296 "../V3Const.cpp"
//    TREEOPV("AstLt    {$rhsp.castExtend,operandBiExtendConstShrink(nodep)}",	"DONE");
#line 6124 "V3Const__gen.cpp"
#line 2297 "../V3Const.cpp"
//    TREEOPV("AstLte   {$rhsp.castExtend,operandBiExtendConstShrink(nodep)}",	"DONE");
#line 6127 "V3Const__gen.cpp"
#line 2298 "../V3Const.cpp"
//    TREEOPV("AstEq    {$rhsp.castExtend,operandBiExtendConstOver(nodep)}",	"replaceZero(nodep)");
#line 6130 "V3Const__gen.cpp"
#line 2299 "../V3Const.cpp"
//    TREEOPV("AstNeq   {$rhsp.castExtend,operandBiExtendConstOver(nodep)}",	"replaceNum(nodep,1)");
#line 6133 "V3Const__gen.cpp"
#line 2300 "../V3Const.cpp"
//    TREEOPV("AstGt    {$rhsp.castExtend,operandBiExtendConstOver(nodep)}",	"replaceNum(nodep,1)");
#line 6136 "V3Const__gen.cpp"
#line 2301 "../V3Const.cpp"
//    TREEOPV("AstGte   {$rhsp.castExtend,operandBiExtendConstOver(nodep)}",	"replaceNum(nodep,1)");
#line 6139 "V3Const__gen.cpp"
#line 2302 "../V3Const.cpp"
//    TREEOPV("AstLt    {$rhsp.castExtend,operandBiExtendConstOver(nodep)}",	"replaceZero(nodep)");
#line 6142 "V3Const__gen.cpp"
#line 2303 "../V3Const.cpp"
//    TREEOPV("AstLte   {$rhsp.castExtend,operandBiExtendConstOver(nodep)}",	"replaceZero(nodep)");
#line 6145 "V3Const__gen.cpp"
#line 2304 "../V3Const.cpp"
...
//    TREEOP ("AstAnd    {operandsSame($lhsp,,$rhsp)}",	"replaceWLhs(nodep)");
#line 6151 "V3Const__gen.cpp"
#line 2308 "../V3Const.cpp"
//    TREEOP ("AstChangeXor{operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6154 "V3Const__gen.cpp"
#line 2309 "../V3Const.cpp"
//    TREEOP ("AstDiv    {operandsSame($lhsp,,$rhsp)}",	"replaceNum(nodep,1)");
#line 6157 "V3Const__gen.cpp"
#line 2310 "../V3Const.cpp"
//    TREEOP ("AstDivS   {operandsSame($lhsp,,$rhsp)}",	"replaceNum(nodep,1)");
#line 6160 "V3Const__gen.cpp"
#line 2311 "../V3Const.cpp"
//    TREEOP ("AstOr     {operandsSame($lhsp,,$rhsp)}",	"replaceWLhs(nodep)");
#line 6163 "V3Const__gen.cpp"
#line 2312 "../V3Const.cpp"
//    TREEOP ("AstSub    {operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6166 "V3Const__gen.cpp"
#line 2313 "../V3Const.cpp"
//    TREEOP ("AstXnor   {operandsSame($lhsp,,$rhsp)}",	"replaceAllOnes(nodep)");
#line 6169 "V3Const__gen.cpp"
#line 2314 "../V3Const.cpp"
//    TREEOP ("AstXor    {operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6172 "V3Const__gen.cpp"
...
#line 6181 "V3Const__gen.cpp"
#line 2318 "../V3Const.cpp"
//    TREEOP ("AstEqCase {operandsSame($lhsp,,$rhsp)}",	"replaceNum(nodep,1)");
#line 6184 "V3Const__gen.cpp"
#line 2319 "../V3Const.cpp"
//    TREEOP ("AstEqWild {operandsSame($lhsp,,$rhsp)}",	"replaceNum(nodep,1)");
#line 6187 "V3Const__gen.cpp"
#line 2320 "../V3Const.cpp"
//    TREEOP ("AstGt     {operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6190 "V3Const__gen.cpp"
#line 2321 "../V3Const.cpp"
//    TREEOP ("AstGtD    {operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6193 "V3Const__gen.cpp"
#line 2322 "../V3Const.cpp"
//    TREEOP ("AstGtN    {operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6196 "V3Const__gen.cpp"
#line 2323 "../V3Const.cpp"
//    TREEOP ("AstGtS    {operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6199 "V3Const__gen.cpp"
#line 2324 "../V3Const.cpp"
//    TREEOP ("AstGte    {operandsSame($lhsp,,$rhsp)}",	"replaceNum(nodep,1)");
#line 6202 "V3Const__gen.cpp"
#line 2325 "../V3Const.cpp"
//    TREEOP ("AstGteD   {operandsSame($lhsp,,$rhsp)}",	"replaceNum(nodep,1)");
#line 6205 "V3Const__gen.cpp"
#line 2326 "../V3Const.cpp"
//    TREEOP ("AstGteN   {operandsSame($lhsp,,$rhsp)}",	"replaceNum(nodep,1)");
#line 6208 "V3Const__gen.cpp"
#line 2327 "../V3Const.cpp"
//    TREEOP ("AstGteS   {operandsSame($lhsp,,$rhsp)}",	"replaceNum(nodep,1)");
#line 6211 "V3Const__gen.cpp"
#line 2328 "../V3Const.cpp"
//    TREEOP ("AstLt     {operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6214 "V3Const__gen.cpp"
#line 2329 "../V3Const.cpp"
//    TREEOP ("AstLtD    {operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6217 "V3Const__gen.cpp"
#line 2330 "../V3Const.cpp"
//    TREEOP ("AstLtN    {operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6220 "V3Const__gen.cpp"
#line 2331 "../V3Const.cpp"
//    TREEOP ("AstLtS    {operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6223 "V3Const__gen.cpp"
#line 2332 "../V3Const.cpp"
//    TREEOP ("AstLte    {operandsSame($lhsp,,$rhsp)}",	"replaceNum(nodep,1)");
#line 6226 "V3Const__gen.cpp"
#line 2333 "../V3Const.cpp"
//    TREEOP ("AstLteD   {operandsSame($lhsp,,$rhsp)}",	"replaceNum(nodep,1)");
#line 6229 "V3Const__gen.cpp"
#line 2334 "../V3Const.cpp"
//    TREEOP ("AstLteN   {operandsSame($lhsp,,$rhsp)}",	"replaceNum(nodep,1)");
#line 6232 "V3Const__gen.cpp"
#line 2335 "../V3Const.cpp"
//    TREEOP ("AstLteS   {operandsSame($lhsp,,$rhsp)}",	"replaceNum(nodep,1)");
#line 6235 "V3Const__gen.cpp"
#line 2336 "../V3Const.cpp"
//    TREEOP ("AstNeq    {operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6238 "V3Const__gen.cpp"
#line 2337 "../V3Const.cpp"
//    TREEOP ("AstNeqD   {operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6241 "V3Const__gen.cpp"
#line 2338 "../V3Const.cpp"
//    TREEOP ("AstNeqN   {operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6244 "V3Const__gen.cpp"
#line 2339 "../V3Const.cpp"
//    TREEOP ("AstNeqCase{operandsSame($lhsp,,$rhsp)}",	"replaceZero(nodep)");
#line 6247 "V3Const__gen.cpp"
...
//    TREEOPV("AstSel{operandSelExtend(nodep)}",	"DONE");
#line 6397 "V3Const__gen.cpp"
#line 2400 "../V3Const.cpp"
//    TREEOPV("AstSel{operandSelFull(nodep)}",	"replaceWChild(nodep, nodep->fromp())");
#line 6400 "V3Const__gen.cpp"
#line 2401 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castSel}",		"replaceSelSel(nodep)");
#line 6403 "V3Const__gen.cpp"
#line 2402 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castAdd, operandSelBiLower(nodep)}",	"DONE");
#line 6406 "V3Const__gen.cpp"
#line 2403 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castAnd, operandSelBiLower(nodep)}",	"DONE");
#line 6409 "V3Const__gen.cpp"
#line 2404 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castOr,  operandSelBiLower(nodep)}",	"DONE");
#line 6412 "V3Const__gen.cpp"
#line 2405 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castSub, operandSelBiLower(nodep)}",	"DONE");
#line 6415 "V3Const__gen.cpp"
#line 2406 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castXnor,operandSelBiLower(nodep)}",	"DONE");
#line 6418 "V3Const__gen.cpp"
#line 2407 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castXor, operandSelBiLower(nodep)}",	"DONE");
#line 6421 "V3Const__gen.cpp"
#line 2408 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castShiftR, operandSelShiftLower(nodep)}",	"DONE");
#line 6424 "V3Const__gen.cpp"
#line 2409 "../V3Const.cpp"
//    TREEOPC("AstSel{$fromp.castConst, $lsbp.castConst, $widthp.castConst, }",	"replaceConst(nodep)");
#line 6427 "V3Const__gen.cpp"
#line 2410 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castConcat, $lsbp.castConst, $widthp.castConst, }",	"replaceSelConcat(nodep)");
#line 6430 "V3Const__gen.cpp"
#line 2411 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castReplicate, $lsbp.castConst, $widthp.castConst, operandSelReplicate(nodep) }",	"DONE");
#line 6433 "V3Const__gen.cpp"
#line 2412 "../V3Const.cpp"
...
//    TREEOPV("AstSel{$fromp.castBufIf1}",		"replaceSelIntoBiop(nodep)");
#line 6439 "V3Const__gen.cpp"
#line 2416 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castNot}",			"replaceSelIntoUniop(nodep)");
#line 6442 "V3Const__gen.cpp"
#line 2417 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castAnd,$lhsp.castConst}",	"replaceSelIntoUniop(nodep)");
#line 6445 "V3Const__gen.cpp"
#line 2418 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castOr,$lhsp.castConst}",	"replaceSelIntoUniop(nodep)");
#line 6448 "V3Const__gen.cpp"
#line 2419 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castXor,$lhsp.castConst}",	"replaceSelIntoUniop(nodep)");
#line 6451 "V3Const__gen.cpp"
#line 2420 "../V3Const.cpp"
//    TREEOPV("AstSel{$fromp.castXnor,$lhsp.castConst}",	"replaceSelIntoUniop(nodep)");
#line 6454 "V3Const__gen.cpp"
#line 2421 "../V3Const.cpp"
    // Conversions
//    TREEOPV("AstRedXnor{$lhsp}",		"AstNot{AstRedXor{$lhsp}}");  // Just eliminate XNOR's
#line 6458 "V3Const__gen.cpp"
#line 2423 "../V3Const.cpp"
    // This visit function here must allow for short-circuiting.
//    TREEOPS("AstLogIf {$lhsp.isZero}",		"replaceNum(nodep, 1)");
#line 6462 "V3Const__gen.cpp"
#line 2425 "../V3Const.cpp"
//    TREEOPV("AstLogIf {$lhsp, $rhsp}",		"AstLogOr{AstLogNot{$lhsp},$rhsp}");
#line 6465 "V3Const__gen.cpp"
#line 2426 "../V3Const.cpp"
//    TREEOPV("AstLogIff{$lhsp, $rhsp}",		"AstLogNot{AstXor{$lhsp,$rhsp}}");
#line 6468 "V3Const__gen.cpp"
#line 2427 "../V3Const.cpp"
    // Strings
//    TREEOPC("AstCvtPackString{$lhsp.castConst}", "replaceConstString(nodep, VN_CAST(nodep->lhsp(), Const)->num().toString())");
#line 6472 "V3Const__gen.cpp"
#line 2429 "../V3Const.cpp"
